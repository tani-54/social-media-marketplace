...
const CTA = () => {
  return (
    <div className="max-w-5xl mx-2 md:mx-auto mb-24 p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">  
                ...
                <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">We are the leading social media marketplace that connectswith their customers with our user-friendly interface.</p>
